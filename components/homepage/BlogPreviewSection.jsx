          ...
          {previewPosts.map((post) => {
            ...
            return (
              <StaggerItem key={post.id}>
                ...
                >
                  <article className="relative h-full overflow-hidden rounded-2xl bg-white shadow-md hover:shadow-xl transition-all duration-500 group-hover:-translate-y-1 flex flex-col">
                    {/* Gradient Header */}
                    <div
